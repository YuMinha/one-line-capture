...
- **커밋 메시지·PR 설명에 `Co-Authored-By` 줄이나 Claude 관련 문구를 절대 추가하지 않는다.**
  `Co-Authored-By: Claude ...`, `Generated with Claude Code` 등 어떤 형태의 AI attribution도 붙이지 않는다.
  커밋은 이 저장소 개발자 명의로만 남는다.
...
**진행 중:** T4.4~T4.6 (VPS·도메인) — Caddy 설정은 준비 완료, 서버만 있으면 됨
**완료:** T1.1 ~ T1.8 (1주차), T2.1 ~ T2.8 (2주차), T3.1 ~ T3.9 (3주차), T4.1 ~ T4.3, T4.7, T4.8
